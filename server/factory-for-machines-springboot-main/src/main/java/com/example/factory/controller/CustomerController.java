...
public class CustomerController {
    ...
    @Autowired
    public CustomerController(CustomerService customerService, AddressService addressService, OrderService orderService, MachineService machineService) {
...
//        return customerService.addCustomer(newCustomer);
    ...
    public Customer createNewOrderAndAddItToCustomer(@PathVariable Long id, @RequestBody NewOrderDTO newOrderDTO) {
        try {
            ...
            for (Long machineId : newOrderDTO.getMachineId()) {
