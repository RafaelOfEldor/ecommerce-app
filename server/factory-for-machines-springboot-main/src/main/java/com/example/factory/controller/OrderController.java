...
public class OrderController {
    ...
    @Autowired
    public OrderController(CustomerService customerService, OrderService orderService, MachineService machineService) {
    ...
    public Order addOrder(@RequestBody Order newOrder) {
        try {
            if (newOrder.getCustomer() != null) {
                Customer customer = customerService.addCustomer(newOrder.getCustomer());
            }
    ...
    public Order addMachinesToOrder(@PathVariable Long id, @RequestBody ExistingMachinesDTO machines) {
        try {
            Order order = orderService.getOrderById(id);
            for (Long machineId : machines.getMachineId()) {
